...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".gitignore",
     ...
     "lib/amazonmws/mws/base.rb",
     "lib/amazonmws/mws/connection.rb",
     "lib/amazonmws/mws/connection/management.rb",
     "lib/amazonmws/mws/connection/request_builder.rb",
     "lib/amazonmws/mws/exceptions.rb",
     "lib/amazonmws/mws/feed.rb",
     "lib/amazonmws/mws/feed_builder.rb",
     "lib/amazonmws/mws/feed_enumerations.rb",
     "lib/amazonmws/mws/feed_submission.rb",
     "lib/amazonmws/mws/lib/extensions.rb",
     "lib/amazonmws/mws/lib/memoizable.rb",
     "lib/amazonmws/mws/orders.rb",
     "lib/amazonmws/mws/report.rb",
     "lib/amazonmws/mws/report_enumerations.rb",
     "lib/amazonmws/mws/report_info.rb",
     "lib/amazonmws/mws/report_request.rb",
     "lib/amazonmws/mws/report_schedule.rb",
     "lib/amazonmws/mws/response.rb",
     "lib/amazonmws/mws/response/cancel_feed_submissions_response.rb",
     "lib/amazonmws/mws/response/cancel_report_requests_response.rb",
     "lib/amazonmws/mws/response/get_feed_submission_count_response.rb",
     "lib/amazonmws/mws/response/get_feed_submission_list_by_next_token_response.rb",
     "lib/amazonmws/mws/response/get_feed_submission_list_response.rb",
     "lib/amazonmws/mws/response/get_feed_submission_result_response.rb",
     "lib/amazonmws/mws/response/get_report_count_response.rb",
     "lib/amazonmws/mws/response/get_report_list_response.rb",
     "lib/amazonmws/mws/response/get_report_request_count_response.rb",
     "lib/amazonmws/mws/response/get_report_request_list_by_next_token_response.rb",
     "lib/amazonmws/mws/response/get_report_request_list_response.rb",
     "lib/amazonmws/mws/response/get_report_schedule_count_response.rb",
     "lib/amazonmws/mws/response/get_report_schedule_list_by_next_token_response.rb",
     "lib/amazonmws/mws/response/get_report_schedule_list_response.rb",
     "lib/amazonmws/mws/response/manage_report_schedule_response.rb",
     "lib/amazonmws/mws/response/request_report_response.rb",
     "lib/amazonmws/mws/response/response_error.rb",
     "lib/amazonmws/mws/response/submit_feed_response.rb",
     "lib/amazonmws/mws/response/update_reports_acknowledgements_response.rb",
     "lib/amazonmws/mws/version.rb",
